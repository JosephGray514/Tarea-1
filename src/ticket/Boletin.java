...
public class Boletin  {
    ...
    public String boletinCalzadoConAlmohadilla(Calzado calzado) {
        ...
        if (calzado.getAlmohadilla() != null){
            ...
            mensajeAlmohadilla += "\u001B[36m"+"El empeine del calzado es de : "+"\u001B[34m"+calzado.getEmpeine().getEstilo()+"\u001B[0m"+"\u001B[40m" +"\u001B[36m"+" de ancho: "+"\u001B[34m"+calzado.getEmpeine().getAncho()+"\u001B[0m"+"\u001B[40m" +"\u001B[36m"+" y de color: "+"\u001B[32m"+calzado.getEmpeine().getColor()+"\n";
